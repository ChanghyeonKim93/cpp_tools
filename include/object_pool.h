...
/* Description:
 This is a 'consecutive' object pool. This object pool allocates 
 consecutive memory blocks. The part of memory blocks is distributed 
 to an arbitrary datatype 'T' by using stack-based method.
...
public:
	...
	~ObjectPool() {
		if (_memory_chunk != nullptr) {
			free(_memory_chunk);
			printf("\n Memory chunk of object pool is successfully returned.\n");
		}
		else {
			printf("\n Already empty.\n");
		}
